...
public class SniperBoss : Ship, IEnemy
{
	...
	public float sqDist = 100.0f;
	// Distance at which it starts backing away from player
	public float spawnDelay = 5.0f;
	public float safetyDist = 100.0f;
	// If player is too close, will use explosives attack

	[Header("TELE LOGIC")]
	public float teleDelay = 0.5f;
	// The time btwn when visual marker for teleport marker appears, and when we actually teleport
	public float teleCooldown = 8.0f;
	// Cooldown time for teleport
	public float postTeleDelay = 1.0f;
	public bool teleportActive = false;

	[Header("LASER LOGIC")]
	public float laserChargeTime = 3.0f;
	public float laserEmitTime = 4.0f;
	// How long we fire the laser for
	public bool laserActive = false;

	public bool isAtking = false;
	// Desc. if boss is attacking
	public int numAtks = 0;
	// Tracks # of times we atked. Useful for if we fire laser mult. times in a row.
